...
const Header = () => {
    ...
    return (
        ...
        >
            <h1 className='text-7xl tracking-wider capitalize font-semibold text-red-600'><span className='stroke font-sans'>Sync</span> Your Strength,</h1>
            <h1 className='text-7xl tracking-wider capitalize font-semibold text-red-600'> Transform Your Life</h1>
            <p className='text-xl font-light tracking-widest'>Join FitSync and take your fitness journey to the next level.</p>
            <p className='w-[70vw] text-base my-5'>At FitSync, we believe fitness is more than just a routine—it’s a lifestyle. With cutting-edge equipment, expert trainers, and a supportive community, we help you stay on track and achieve your goals. Whether you’re here to build muscle, improve endurance, or just stay active, we’ve got you covered. Let’s sync up and get stronger together!</p>
            <div className='flex'>

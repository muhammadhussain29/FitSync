...
const Header = (props) => {
    ...
    return (
        ...
        >
            ...
            <p className='text-xl font-light tracking-widest text-gray-400'>Join FitSync and take your fitness journey to the next level.</p>
            ...
            <div className='flex'>
                <button onClick={props.handleScroll} className='button px-7 py-3 text-nowrap mr-5'>Leran More</button>

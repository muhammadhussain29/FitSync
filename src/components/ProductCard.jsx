...
const ProductCard = (props) => {
  return (
    <div className="roboto relative w-[260px] h-[380px] bg-gray-900 rounded-2xl overflow-hidden flex flex-col items-center text-center shadow-lg group">
      {/* Animated Background */}
      ...
      {/* Content Box */}
      <div className="relative p-5 flex flex-col items-center top-10 group-hover:top-2 z-10 transition-all">

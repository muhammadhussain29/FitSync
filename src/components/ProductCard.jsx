  ...
  return (
    <div className="relative w-[260px] h-[380px] bg-gray-900 rounded-2xl overflow-hidden flex flex-col items-center text-center shadow-lg group">
      ...
      <div className="relative p-5 flex flex-col items-center z-10">
        ...
        <a
          href="#"
          className="relative top-8 opacity-0 py-2 px-6 mt-4 text-black bg-red-600 rounded-full uppercase tracking-wide transition-all duration-500 ease-in-out group-hover:top-0 group-hover:opacity-100"
        >
          Buy Now
        </a>
      </div>

    ...
    <section className='roboto flex flex-col justify-center items-center md:px-16 px-8 py-10'>
        ...
        <div className='flex border my-10 text-center rounded-2xl overflow-hidden'>
            <div className='py-10 px-14 w-1/2'>
                ...
                <p className='text-lg'>At FitSync, we are more than just a gym—we are a supportive community. Our team is composed of passionate fitness enthusiasts, expert trainers, and individuals who share a common goal: to help you become your best self. Whether your focus is weight loss, muscle gain, or overall wellness, we are committed to providing the guidance and motivation needed every step of the way. FitSync is a space where everyone, no matter their fitness level, is welcomed and encouraged to progress together.</p>
            </div>
            ...
            <FaDumbbell />
                ...
                <h4 className='text-2xl text-white capitalize font-semibold my-3' >What We Offer</h4>
